...
public class Constant {
    ...
    public static final String APPID = "32DvCnNN4gSewCcXWfLczjkOmSIa";
    public static final String SECRET = "4y8WCCwKOW4h1d51zu1AiwaWQOAa";
     ...
     * please replace uri, when you use the demo.
     */
    public static final String REPORT_CMD_EXEC_RESULT_CALLBACK_URL = CALLBACK_BASE_URL + "/SecondSpringMVCProj/api/reportCmdExecResult";
     ...
     * map用于存储device实例
     */
    public static List<DeviceModel> DEVICE_REPO = new ArrayList<>();
